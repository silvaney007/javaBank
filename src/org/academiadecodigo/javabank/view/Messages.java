...
public class Messages {
    ...
    public final static String SYSTEM_ERROR = "The costumerServiceImpl system is having issues...";

    public final static String VIEW_LOGIN_WELCOME = "Welcome to Java CostumerServiceImpl";
    ...
    public final static String VIEW_ACCOUNT_TRANSACTION_NOACCOUNT_ERROR = "Open a costumerServiceImpl account first, please!";
